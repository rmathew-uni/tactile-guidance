...
Reference this file structure image for an overview of the scripts and folders needed to run the AI paradigm - [AI Paradigm](https://github.com/pippowell/OptiVisT/blob/main/file_guide_opti.png)
