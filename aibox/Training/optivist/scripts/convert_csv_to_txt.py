...
for file_name in csv_files:
    csv_file = f'/share/neurobiopsychologie/datasets/egohands/csv_val/{file_name}.csv'
    txt_file = f'/share/neurobiopsychologie/datasets/egohands/txt_val/{file_name}.txt'
