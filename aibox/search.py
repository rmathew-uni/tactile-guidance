...
def navigate_hand(belt_controller,bboxs_hands,bboxs_objs, search_key_obj: str, search_key_hand: list, hor_correct: bool = False, ver_correct: bool = False, grasp: bool = False):
    '''
    ...
    # if the object is visible but the hand is not, indicate to them that their hand should be moved into the field of view
    if bbox_hand == None and bbox_obj != None:
        ...
        return True, False, grasp

    # if neither the hand nor the object is visible, indicate they should move their head around and search for the object
    if bbox_hand == None and bbox_obj == None:
